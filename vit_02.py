...
# -*- coding: utf-8 -*-
"""
GPT Generated ViT classifier (was vit_keras2.py)

~ Same as vit_01: -> Converted to use Vanilla attention (from vit_03)
"""
##===================== MEMORY FRAGMENTED =========================##
#import os
...
def plot_metrics(history):
    ...
    epoch_stop = len(history.history['accuracy'])
    ...
    plt.grid(True)
    plt.legend(['train','val'],loc=4)           # bottom right
    plt.style.use(['classic'])
    plt.savefig('ViT_02_Acc_96_100.png')
    ...
    plt.grid(True)
    plt.legend(['train','val'],loc=1)           # top right
    plt.style.use(['classic'])
    plt.savefig('ViT_02_Loss_96_100.png')
    ...
    plt.legend(['train','val'],loc=4)           # bottom right
    plt.style.use(['classic'])
    plt.savefig('ViT_02_Prec_96_100.png')
    ...
    plt.legend(['train','val'],loc=4)           # bottom right
    plt.style.use(['classic'])
    plt.savefig('ViT_02_Rec_96_100.png')
